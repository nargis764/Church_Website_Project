...
const MiddleGrid = () => {
    ...
    return (
        ...
        <div className = "grid grid-cols-1 place-items-center bg-slate-200 py-10 lg:py-32 mx-16 lg:mx-36 mt-10 tracking-wider lg:grid-cols-3 gap-5">
            ...
            <p
                className = "cursor-pointer text-sm text-gray-500 font-semibold hover:text-blue-500 hover:scale-125 ease-linear duration-400 transition-all lg:text-2xl lg:mt-20"
                onClick = {() =>
