...
export default function Home() {
  ...
  return (
    <div className = "w-screen">
      ...
      <div className = "px-10 pt-10 lg:text-xl">
        <p>Established in 2008 through merger of the parishes of St. Peter in Riverside and St. Joseph in Beverly, this vibrant diverse Catholic 
          family of the Diocese of Trenton serves the Delaware Riverfront communities of Beverly, Burlington Township, Delanco, Edgewater Park and 
          Riverside.</p>
      </div>
