            ...
            <div className="px-20 lg:px-44">
                    ...
                    <div className="lg:col-span-3">
                        ...
                        <p className="text-lg mt-2">
                            ...
                            <Link href={`mailto: ${"j.bedoya@jesusthegoodshepherd.org"}`}>
                                <a className="text-gray-600 text-lg underline"> abuseline@dioceseoftrenton.org</a>
                ...
                <p className="mt-2">
                    Email:<Link href={`mailto: ${"m.gimello@jesusthegoodshepherd.org"}`}>
                        <a className="text-gray-600 text-lg underline"> m.gimello@jesusthegoodshepherd.org</a>
                    </Link>
                </p>
                ...
                <p className="mt-2">
                    Email:<Link href={`mailto: ${"e.perez@jesusthegoodshepherd.org"}`}>
                        <a className="text-gray-600 text-lg underline"> e.perez@jesusthegoodshepherd.org</a>
                    </Link>
                </p>
